...
- Add Review PRs
- Surface PR merge diagnostics, including unstable optional-check failures
...
|          | close                                             | Close the current PR (prompts for an optional closing comment)                                                                                         |
|          | checkout                                          | Checkout PR                                                                                                                                            |
|          | commits                                           | List all PR commits                                                                                                                                    |
|          | changes                                           | Show all PR changes (diff hunks)                                                                                                                       |
|          | diff                                              | Show PR diff in a readonly `octo://.../pull/{number}/diff` buffer. Outside a PR buffer, shows the diff of the PR matching the current branch             |
